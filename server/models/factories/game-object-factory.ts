...
export class GameObjectFactory {
  ...
  public createBomb(x: number, y: number): IGameObject {
    return new Bomb(x, y, GLOBALS.tilewidth, GLOBALS.tileheigth, GameObjectFactory.pid += 1);
  }

  public createBoundary(x: number, y: number): IGameObject {
    return new Boundary(x, y, GLOBALS.tilewidth, GLOBALS.tileheigth, GameObjectFactory.pid += 1);
  }

  public createDestructable(x: number, y: number): IGameObject {
    return new Destructable(x, y, GLOBALS.tilewidth, GLOBALS.tileheigth, GameObjectFactory.pid += 1);
  }

  public createEnemy(x: number, y: number, path: IPoint[]): IGameObject {
    return new Enemy(x, y, GLOBALS.tilewidth, GLOBALS.tileheigth, GameObjectFactory.pid += 1, path);
  }

  public createIndestructable(x: number, y: number): IGameObject {
    return new Indestructable(x, y, GLOBALS.tilewidth, GLOBALS.tileheigth, GameObjectFactory.pid += 1);
  }

  public createPlayer(x: number, y: number): IPlayer {
    return new Player(x, y, GLOBALS.tilewidth, GLOBALS.tileheigth, GameObjectFactory.pid += 1);
  }
}
